...
## [2.1.2](https://github.com/ottnorml/pionxzh_chatgpt-exporter/compare/userscript-v2.35.2...userscript-v2.1.2) (2026-09-24)
...
* add `{chat_id}` to filename varaible ([d27e225](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/d27e2258d55261a14c08d1255c131d4463caef2d))
* add `{model}` and `{model_name}` to variable ([057fe9f](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/057fe9fcfd0ef8e3e9fe834a976d56b3134b86b3))
* add conversation timestamp on page and HTML, revamp setting UI ([531a766](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/531a766bc89fde5b141efc80ea090f00380e1b42))
* add getOobaString and getTavernString for conversion to other formats ([214111b](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/214111bc6ce73cbf6ad0f8af9aa577b9eebe9798))
* add loading effect on menu button ([6e5bc12](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/6e5bc125bfd239e4e26d18565956bc22cb2cea3a))
* add optional export of thinking/reasoning process ([4df6676](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/4df6676826591e7770d6d121c77f1214f19178eb))
* add project support ([9ddd11f](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/9ddd11f715b267ecd10f8b1a641287e0ae7bb0b2))
* add russian lang support ([#255](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/255)) ([2562d4a](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/2562d4a36042d025f3d7fc1190618461fa0127ae))
* add setting dialog/ support `{date}` in filename ([f219def](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/f219deff6462d6c691778fa5251e7afa4c94999d))
* add width toggle ([3cfe3e2](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/3cfe3e249b2c5f209ae8425e4f8cfdb2b9b8c4db))
* added support for create_time and update_time metadata parameters per [#94](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/94) ([#114](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/114)) ([5df4ba6](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/5df4ba6050292db1f88a12a77dcd1f46eeccba55))
* basic support for response from plugin ([c45fdbe](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/c45fdbe4a48ec90947d03c2fb3c5ad67e9bff5e6))
* batched export, smart rate-limit backoff, filter chips, and dialog UX improvements ([#348](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/348)) ([462836d](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/462836d1b22a8002cf8bc9d9d1f1c6de820624e4))
* concat the output of official "Continue generating" ([b191ec2](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/b191ec25cc33cd7ff1dc96ef65d1f8fe60d74cfb)), closes [#146](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/146)
* export currently open temporary chats ([#375](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/375)) ([c397f0d](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/c397f0df530ed3ad30c7939c0febd683fc5242dd))
* export metadata ([4b92e53](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/4b92e53b106ca49bec67e683ce8bd19280147700))
* **export:** make max-message-export configurable ([832732b](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/832732b90c65e9c4bb57d4276a66323ab39ad540))
* **export:** select not-exported or updated conversations ([68eee3a](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/68eee3a91c53a0bad818c219efe3494d342ab804))
* **i18n:** add french translation ([#266](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/266)) ([a71cad4](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/a71cad4cb0b1fdbb2fea193f225c3c57cca9318b))
* **i18n:** add spanish to lanaguage list ([2b2f75c](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/2b2f75ca0579b723beda03e42c8790931cebd6c1))
* **i18n:** add spanish translation ([#137](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/137)) ([08a6930](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/08a693005e19360c15d2577b914bbdd754adeac4))
* **i18n:** add turkish to language list ([b05776f](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/b05776fe4f85bd4c4cca9a80cff808c3be4042b2))
* **i18n:** add turkish translation ([#128](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/128)) ([9ad8e0a](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/9ad8e0a3c6fa0cfec5ced00b04caaf6f8441c162))
* include project name in export all zip filenames ([9c1ad6f](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/9c1ad6f6c0edd10fc72b3ff4238e49e33dce9c11))
* latex rendering with katex ([972175e](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/972175e362c015ab67e402675ac653883e30348e))
* partially support `multimodal_text` ([7d5c7de](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/7d5c7de30b7b9f7f9ec88fb1fb45f52e7b3b3a69))
* remove copy button in chat in favor of the built-in copy button ([66dbaa6](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/66dbaa669fe0379b0137b67648716e9782cf087e))
* remove pandora ([115687d](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/115687dbad7f48b3204025b244eb64187fb9ae9f))
* replace Last 100 and offset-resume controls with a shift-select hint ([43fb9f7](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/43fb9f741e3f3f56e3a52173d479c19d6e08f240))
* replace screenshot renderer with SnapDOM ([f6c38b2](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/f6c38b2bb09052ad6a205df88b3e1ab04cd172a2))
* restore project filter in export dialog and improve layout ([e03f32b](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/e03f32b2a26c9c75df5b07014d1d818be3102f79))
* rewrite the plugin with API based data source ([4ecf34a](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/4ecf34ab726ec6c38efd213a7a4bfb8b28d67bad))
* show message to user when history api disabeld ([9025934](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/9025934ced76b0d0b2c71e3c6247c5d233ccb178))
* show timestamp on each chat post ([e602c7b](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/e602c7b73f5b0e6594af0c55de2569c1c572acf7))
* support "archive conversation" in Export Conversations dialog ([706cef2](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/706cef2b5a45a0fa5fe853d0cc889502f60027a0)), closes [#199](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/199)
* support /gpts paths ([efbd662](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/efbd662c772c6e6188b93c166397f1a98cb9baaf))
* support `chat.zhile.io` ([4331bd8](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/4331bd8f936b935ae47839a56e989481ca97f13f)), closes [#143](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/143)
* support audio chat ([e1d1a2f](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/e1d1a2f6457a881c5ba88aa89c33e5983ca74f05)), closes [#298](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/298)
* support chatgpt.com ([07bcf0b](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/07bcf0b30f96d4157915eb88d220ddf11923f21c)), closes [#232](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/232)
* support conversation timestamp in markdown export ([38f4a97](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/38f4a97a9d1d7ab32190f1100a370429baf4b34e)), closes [#155](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/155)
* support copy text of single response from ChatGPT ([0a78d2e](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/0a78d2e17ae96a9182e289cbb7b9ade465f740b9)), closes [#63](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/63)
* support delete conversations ([554b26d](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/554b26dbe9ca6566a864670dd8c337834f266139)), closes [#85](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/85)
* support export to tavern and ooba format ([a28f9fd](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/a28f9fdc353464d32d92a5d977272de324628e3a))
* support exporting from official export ([ac59789](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/ac59789f508433675bfd9a492e6887035c588067)), closes [#121](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/121)
* support footnote ([35d74e0](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/35d74e0f9e02cd81a2a705bed47cafc26243c98f))
* support GPT-4 avatar in HTML export ([890f10d](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/890f10d56ac0b8df15e6b5bad48f5e56a73c142a)), closes [#81](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/81)
* support i18n ([918ff41](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/918ff41dc459d228e0c5e09dead41b1abc1c2f4e)), closes [#91](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/91)
* support image in execution output ([38c65b9](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/38c65b910db0ef8c38e1465df1e643cccbfad4bb)), closes [#191](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/191)
* support JSON export and export All ([ce0d895](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/ce0d895bacb269f00f757dbab7a165123ba6a239))
* support multi-modal ([#179](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/179)) ([c5ed341](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/c5ed3413d52a1122775fdc2fc872c719c651d2a2))
* support new.oaifree.com ([6bf6ae0](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/6bf6ae0b928a91c9af30be21c3aea16fe19a6816)), closes [#236](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/236)
* support OpenAI official JSON format ([66d8f90](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/66d8f90cb22ff46e45ccd18c17ed3dd269244d46)), closes [#162](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/162)
* support running on gizmo page ([#182](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/182)) ([d278210](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/d27821027863f7efaf7ef1e4bb4e2f765d57252a))
* support sharing page ([50462cd](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/50462cd0ba9adea279b5b16c7445a6214424d2d1)), closes [#147](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/147)
* try support team account ([7937b05](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/7937b051bb7cca94053ee2f34054989ad7e4bb24))
* use the same Toggle as ChatGPT's setting ([0f91b56](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/0f91b5698bd0e01c9f5d1008062fb48a3e93e7cc))


### Bug Fixes

* [@match](https://github.com/match) url should have a tralling `/` at the end ([f0f64d4](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/f0f64d49963946bd8aab3a6f213cfa5df980139c))
* adapt remix version and try to reduce call to session api ([950c8fc](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/950c8fc7cf8c9c626ace90bee4a82b482c42a40c))
* adapt to chatgpt new sidebar ([fa68986](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/fa68986831e36a35ab4a8f9fbd472f4a1db99c8e)), closes [#352](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/352)
* add [@match](https://github.com/match) for new ChatGPT domain with query parameter ([e48c902](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/e48c9020214e6f573959c5bbedceed62c7b37840))
* add explicit ApiConversations type annotation to resolve TS7022 ([b31d5cd](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/b31d5cd565d74b502d06b14883b22b8ab105b82d))
* add log on script startup for better debugging ([87e5679](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/87e56790ee7395df50a8bd563450d7b930c4d32c))
* add missing {chat_id} in Export All ([c8e52aa](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/c8e52aaf0d3678ade1c6da01b8171eb9d666423f)), closes [#106](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/106)
* add missing css `ml-4` ([f5974d4](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/f5974d4bd8bd63c2df18387ac4401d64f4b256ba))
* add missing translations and drop unused locale keys ([a476616](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/a476616ffcf3064a0e0375157e49de8cb0f710ed))
* add scrolling to settings dialog ([a106e8b](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/a106e8bac27d6545afb723331519747db454a107))
* adopt latest sentinel-js, no more patch ([631332d](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/631332dac23406189ce44929fc1aec9c4b273e67))
* **api:** fix project-level chat export stuck at "Loading" ([f4c4a7f](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/f4c4a7f1324b7d3506dc6cdf1db1a69ae43e0028)), closes [#305](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/305)
* avoid hang when exporting voice chat ([#262](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/262)) ([9924c09](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/9924c0986945233cbf5d1b2b32d90c97a49ec516))
* build conversation list with bottom-up method ([#193](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/193)) ([dc157f7](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/dc157f7dc29af6b5eded46287bf75e219197f694))
* chatgpt changed from file service to sediment ([ab01af1](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/ab01af10afad4747965b11b6d42d9130364687d7)), closes [#333](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/333)
* check if conversation started ([a60bedc](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/a60bedc6dbb4819f02e9617861c74934e49cb40b))
* conversationChoices should only applied to node with recipient all ([bd36162](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/bd3616282ea570e31d2a91f801aeec45d9699dab))
* conversion problems listed in [#222](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/222) ([56e6cef](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/56e6cef513d8782ec11e1382f0b1a2204b8f77a1))
* copy button shows in code block incorrectly ([b43dbc8](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/b43dbc88727a7d2ba66ac5ce1c4e8f19306819eb)), closes [#83](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/83)
* correct model names from 'GTP' to 'GPT' ([43f29e4](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/43f29e41fbe95903a23a3763c6f3ba11768f6f9e))
* correct timestamp default ([0b1109b](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/0b1109b0d18470e4d1a8f188b63467d80e82f3a4))
* derive model name from the slug ([bb9ea2c](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/bb9ea2cee9239625df4d7c78ea8c7aa0c60125b4))
* disable the chip system ([e3a54a3](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/e3a54a3bd2e1bde60ef60ff71c40c135912bd2d4))
* do not render export dialog until needed ([#178](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/178)) ([1e7f0fa](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/1e7f0fa0b56963272969a72904d2ce9760e785ef))
* drop oaifree.com support and update description ([c3e2d11](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/c3e2d11c963b5222cfd71d5adf29f5d4534cb5e2))
* error handling for avatar fetching ([d8af0ec](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/d8af0ecbba3ee6666d5a000853e0779c69bab135)), closes [#73](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/73)
* error handling on menu onclick ([f0b7c7f](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/f0b7c7f7dc365102e4d25ae246fce6afda3ca876))
* escape title and metadata in HTML export ([7787cdc](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/7787cdc6cb51eb5b9af3d6b9fa21445b430ddd86))
* export all is not openable ([ea69a4f](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/ea69a4fe65bcd9cdeac8799f553f8cae422a6e3e))
* export all should enable compression ([ca9d5c5](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/ca9d5c512f92bb423aabc3b6ab25befd1d52e591)), closes [#141](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/141)
* export all should load all of chats ([770f129](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/770f1299818309df46a85593ac5789b167977b72)), closes [#86](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/86)
* export answer source lists ([5b56f35](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/5b56f354c7fa49d814928cbd0b4f1d48b9ec21e2)), closes [#361](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/361)
* export chats from nested share URLs ([c1dddad](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/c1dddadf06a788a4c9581cd33bbe800671f0dd6c))
* export temporary chat response callbacks on Firefox ([66aeac8](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/66aeac8008dd8b5d66c0fb3be21657c2a71d3bc8))
* filter model memory context message ([a99c9f1](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/a99c9f127b3bbdfc3b7d2b1e302a27af4bdaa39d))
* fix broken style becasue of the updates and improve light style ([ab246ac](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/ab246acf905cdb1a550adaeefc90ffc612d03549))
* fix broken timestamp ([613247f](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/613247f2a914fc4c1f6459d8e922b09d5b2c57ef))
* fix button position disappeared on new sidebar layout ([d3b73cb](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/d3b73cb4dd4727788d9dd4697b358562c99a293b)), closes [#290](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/290)
* fix characters overlap in screenshot ([aef813c](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/aef813c2a0bfff66e8c37fdbfb08a6536446dd34)), closes [#216](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/216)
* fix checkbox style ([e1b41c9](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/e1b41c9cd73333f1123049a4d5d3e1c359cf0f9c))
* fix close button position in Export Dialog ([2498d55](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/2498d55fde57c80d87aec8ac80738ce09d87d511))
* fix conversation choice selector ([355e07d](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/355e07d4efe8b7b3dc597ca1576d65874f7a8734))
* fix conversation started detection ([c5bbb82](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/c5bbb82f2861294c9f2f6cd56da18c0fa20728a6))
* fix export twice ([38c6be3](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/38c6be3a1589d1d6c4245bc8a0d30ed086986f4b))
* fix exporting markdown with timestamp ([87c2cb7](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/87c2cb74bafc3594f7bb7272cf3f0f57795a9ab8)), closes [#296](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/296)
* fix menu is not working after OpenAI page update ([9632818](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/9632818845ad6d92df00c53e91211eb448b33b47))
* fix missing toggle style ([69d0deb](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/69d0debbd1316f6219fc2b863649aaab0269b4fe))
* fix popup position on mobile (esp sharing page) ([3b39746](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/3b397468e17683c09aa312b12504d66654f33f9f))
* fix screenshot and conversation choice ([4bb56f8](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/4bb56f8fc2adab3c62c6ef25a8022fc5cb0b76a4))
* fix screenshot export ([b65515c](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/b65515c899aee813560ad76c016dcd2dfb366ed5))
* fix screenshot not work in latest layout ([f62bbbd](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/f62bbbd5e6e6a18c49bc1c233685fc18608ea7dd)), closes [#287](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/287)
* fix the script not working on share page ([64849a6](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/64849a63161571316e54a3eb3034130b9a3ab736))
* fix toggle style ([103b617](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/103b6170ff3feaac87cb94e94bfb7c19c688964c))
* fix toggle style in mobile view ([dcd9c97](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/dcd9c970adefa6aaea699148b62b49274218e31a))
* fix unexpected latex formula escape ([30f0b62](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/30f0b623b306aff6ec5a2278207cf2481a609b85))
* fix upload button style ([2960a92](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/2960a92ae47eab5b88b05be19223b98ea32ca3e6))
* fix wrong dimensions of user pfp in screenshot export ([ad679cd](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/ad679cd107bead80c865eca74efe232673aa200e)), closes [#53](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/53)
* fixed user conversations disappearing when exporting screenshots ([eaf7c76](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/eaf7c76af99fb78516732ab3f68f62a9f67d588c))
* further improve the code and execution result's output format ([49cfd6e](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/49cfd6e2b036240bafd690bc49fd7ac233515b39))
* get accessToken from unsafeWindow and provide a fallback to session API ([0accd66](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/0accd66beb740d1b02b2fda392c7d6c20fe5b8dc))
* gizmo mode is now the detaul mode ([7d83072](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/7d830723dba87e46b278831aad16acce72c418e5))
* handle `GM_*` function might be `undefined` ([77b52b1](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/77b52b12fb52ab05c8ea7c49c65c965c99e6281b)), closes [#112](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/112)
* handle alphanumeric cursor pagination for project conversations ([0e17703](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/0e1770356ecc7ef5321c05297fbcd4a90baf0688)), closes [#341](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/341)
* handle canvas size might exceed browser's limit ([3e6629d](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/3e6629d2b5117f8471eb1ba30f6a5337e477f993))
* handle empty dataUrl ([6c89be9](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/6c89be9c1b97da0179f4595689fddfa587bc2509))
* handle failed callback ([6739500](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/6739500aa55c37bf093d5de18ef9b84e1b58b6f6))
* handle frozen page props ([75b5f9d](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/75b5f9d51a9e5c4de74e5ce51b891d56f86c5878))
* handle hydration missing menu and style ([bf687da](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/bf687da24ca62cb4146aac4aa7e4482c51ca5aa4))
* handle oversized screenshot on firefox ([ce2356e](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/ce2356e17f280b5217ca5277ee1bbf07e8148638))
* handle rate limiting in export all ([ba739e0](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/ba739e017bf4c596a74a9a4db85270c450313b43)), closes [#88](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/88)
* handle skipping thought/reasoning message ([d659b9d](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/d659b9db838c0d3b0539e41f67d6e4f79bcc67ff))
* handling same chat name in export all ([aa513b1](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/aa513b1bdde84a12d96d92956501ceec2c270a26)), closes [#117](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/117)
* handling screenshot spacing on MacOS Firefox ([dea099d](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/dea099dd21b16d2f766e0e30546ebaac50d4a72b)), closes [#78](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/78)
* hide feedback bar in screenshot ([3763ad7](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/3763ad71ac90f0a1e0a35bd0a6a0d7f038cf843e))
* hide GPT-4 model text ([796899e](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/796899e0a811044bbbb65031246b26210aed506f))
* honor shouldReplaceAssets for shared conversations ([62963b8](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/62963b83c73af501d77f9f6194cde8a58197bbed))
* **i18n:** fix Malaysia should use `ZH_Hans` ([9e2b748](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/9e2b7485b340430729cea4819b5c345394129c11))
* **i18n:** improve minor issues in translation ([e35bb3a](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/e35bb3aed92f03cde20a561d829be5a9b47060f7))
* **i18n:** update `Invalid File Format` in Turkish ([5cbb2e9](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/5cbb2e94eebb28797f94322c0e4b0136f8883d89))
* **i18n:** use `contohnya` instead of `mis.` in Bahasa translation to avoid confusion ([02909ec](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/02909ec0b1ccd3294a67496763d2cd9ba2a5ca4b))
* improve batch export dialog mobile responsiveness ([25339e6](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/25339e67b4b2ffea1246378e50d43f153c8ab97d))
* improve collapsed sidebar exporter UX ([6b36cbb](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/6b36cbb90ae8117647e74cea49356054ec835a6e))
* improve content reference handling for citations and entities ([5f08862](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/5f08862f3852ce970d663c0990d3877e599b5e7c))
* improve language detection by respecting oai language setting ([6189cc0](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/6189cc065c4242c40af6dab5d431de1361744f3b))
* improve layout and style ([0c801cb](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/0c801cbf26563dfcf858039ea42f3c8065d8ba65))
* improve menu injection ([542c23d](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/542c23da68672af507d8b17b8a5c452b33690cee))
* improve menu popup and select styling ([73f91a2](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/73f91a2a728ed36023fdc11f7374176429ea45d9)), closes [#357](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/357)
* improve model name mapping ([c7ee677](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/c7ee6776feda3f58e1aba62667791f28cf91596b))
* improve release ci ([0fd4af8](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/0fd4af89959492791e8a05a65bad82a9bad1e4eb))
* improve shift select user experience ([df1af4b](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/df1af4bdf874a4cbbbb288ffc1e8a18221184edc))
* improve the UI and missing bg ([8460531](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/84605316a95da5f5d9d6b3a8027e591aa65c05a4))
* improve timestamp injection ([e0eaa65](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/e0eaa656f8bdf410e6c3ec78116c427a7fbd57b7))
* jszip is not defined in prod build ([8b57e16](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/8b57e164eab9fef1ae8bea1610ff639ece680f37)), closes [#75](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/75)
* keep display math and `$` in HTML export ([4662547](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/46625473249655894d475021d27fad26a34c8bcc))
* keep formulas intact in text export ([6376c96](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/6376c9680e02f8f1030a644292ab9077ff64781d))
* keep product names in shopping answers ([4ffda29](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/4ffda29ad3afdc9790c0efa4d0a28e78b870562e))
* keep raw conversation intact when processing ([fc910b5](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/fc910b5ef3a5750eba331f37f693aa773a1068fd))
* keep the select toolbar on one line at any width ([cc04675](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/cc04675365cdd81473e021ae0ceef4c4cac59dad))
* keep thinking order and include preambles in thinking export ([c9877f2](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/c9877f20aaa57df48d780f00f5d3340d315c2712))
* label generated images as ChatGPT ([ba8bea2](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/ba8bea204c75621f9465c5ed43c4e673025aeb8e))
* layout overlap with menu on mobile ([705afe5](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/705afe5bef153fe0f3af53b2eb26633c386d23fe)), closes [#134](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/134)
* let html export's max width adapt to the screen size intead of the fixed 800px ([9249279](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/92492792513b7a47e880c521e13ae9161f9528c3)), closes [#247](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/247)
* lint ([6cafb3c](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/6cafb3ccd5d95cb849093f8a20292a691c876ea3))
* lint ([722c752](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/722c752bb9e52a59fde012ed90967b7df927b2ad))
* load all projects  with cursor ([9452700](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/9452700c2b44f1b66a6756cc73c8796628c6667e)), closes [#336](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/336)
* load plugin on page with model query string ([5d64f04](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/5d64f045ba9bba28af468b34c40989c5655b4cdc)), closes [#100](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/100)
* messages from tool shouldn't use conversation choice ([aff5ce1](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/aff5ce18fe309e3eff2f0eb3ebdee1818745db79)), closes [#173](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/173)
* model bar should be hide correctly ([8b8844b](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/8b8844b2d3a5e764f32ec57562eb57537375db07))
* natural translations for the batch-select options ([25358f8](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/25358f8ea9ac8c2654aaa972cba2a7ef9c37f661))
* paint the menu background in light mode ([1388cdf](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/1388cdf31aea0bfd7dbd37e57af890cff262a384))
* parse citations and suppress 'thoughts' ([748e1b9](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/748e1b9703ab6fb0d09fad9ea779be4572852cd8))
* permission denied on Firefox ([87dbdf0](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/87dbdf0c59c30027f959c3dc2d080efc5f21bc94))
* pin the settings Save button below the scrollable body ([25264ad](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/25264ad249315d18ddbd16d94f2cc0dc9485f174))
* port continuation merging back and remove conversation choice ([b1ff972](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/b1ff97235d41204937c12b28cb59d50387ee9984))
* preserve all text parts in Ooba exports ([3244bf1](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/3244bf161bbc34ed5e62c945ee17b330748c7821))
* preserve citations and content references when merging continuation nodes ([5cd8986](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/5cd8986e42cb69c7b346d9c4dcf5864d1ac432f4))
* preserve multimodal tool image exports ([7998a4f](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/7998a4fcc52a6ad16d9e7607a124d43143e95b7b))
* preserve raw conversations in JSON exports ([b06d472](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/b06d472352a6a8677ce9259686630ad1cde4b330))
* raise the export menu above ChatGPT's main column ([20e6b2e](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/20e6b2ebc5f35abe5dd3719c7dbec57a9154a0cc))
* reduce bundle size by externalizing and dropping modules ([c59faab](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/c59faab9a7c9f5e8bdcc4d5d3c75eb1b2ba03680))
* reduce the blurriness of screenshot export ([42a1d75](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/42a1d75ca735ff5cf449758425a13a0fba959eb3)), closes [#129](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/129)
* remove `verbatimModuleSyntax` to pass type testing ([171fcb8](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/171fcb83a6ec090f866ea33c17140e214ec73edd))
* remove HTML export odd child highlighting ([c3cd253](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/c3cd2538f2c1c081783c325bcddcf17ac48ebbb7))
* remove localstorage legacy migrator ([00ad390](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/00ad3902f2044dfe05a918a3671f81abe6e35cd3))
* remove revison and buttons from screenshot ([ba41b79](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/ba41b7951675f87a934f438bc69e343cf8743b07))
* remove unsplash related workarounds ([ba6f2f7](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/ba6f2f7e57bb0c7b73a39e401a9343f954da978e))
* remove weird white rect from the bottom of screenshot export ([fdcf86d](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/fdcf86d5d25a3e5cc44fb9db9f5366617bbf0e55))
* replace every metadata variable occurrence ([f71c1ca](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/f71c1cafece8311041809d58b2837e0e31f96887))
* replace latex annotation `\[ \] \( \)` with $ for better compatibility ([6e72297](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/6e72297a065722947eae2afd6635ac27a1c95abb)), closes [#187](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/187)
* replace model_name metadata variable in HTML ([d7841a2](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/d7841a22161280301770aa2648b8a838d0fcbde9))
* respect line break and improve text style ([c9e60bc](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/c9e60bc613f9cc394a09850196d40d8decdf81bf))
* retire access to __NEXT_DATA__ and __remixContext ([f5ef7fe](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/f5ef7fe30152dc92ffd4c119a954f8e900dd9e97)), closes [#362](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/362)
* set a hard cap 100 on export conversations to avoid OOM ([2fd3516](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/2fd3516993e06cff58e7394c9cbe257961d3fcc7))
* setting dialog should allow scroll when overflow ([cd3340d](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/cd3340dabf4fe6907a21e641c3d7a08e8518dcdc))
* shorten Screenshot menu label in es/fr/id so it fits on one line ([2b7ad45](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/2b7ad4511ed3b541d84c98e406eee6443e0be4da))
* should not output \[image] ([5478d65](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/5478d6586cb143aa03548aedff375177ced614e7))
* should not output response from plugins ([8d4ee37](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/8d4ee3752a240e8252a68d06d8b0144fcbdf13c1))
* show `[image]` for multi-modal in text export ([ddfbee7](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/ddfbee7ae632085f765e1bf8996136bd660132ed))
* show file names for citations of uploaded files ([15368f9](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/15368f963792b6dd5cabad612441855df1b750a3))
* show image search results as images ([56bb8ae](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/56bb8ae67747fec4d85f950f6a9cfa3f96eac19a))
* show the real selected total in the export progress instead of batches x 100 ([918e3a3](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/918e3a35e108bf88ea9276fd0200f2adff2390e2))
* skip empty assistant replies in exports ([82ff6c8](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/82ff6c8e2cb5b0e874accb481afd4a4ce6eb65c1))
* skip file search tool exports ([986e053](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/986e0538717adb31954d00e580a1c01a492495d3))
* skip hidden tool messages in exports ([3d49174](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/3d491744f49824e79198b77d6b8b745fc6a5ad32))
* skip thinking preamble messages in exports ([16fd74d](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/16fd74d8ce9abd8f9798914f65ac0c027aeb78c8))
* skip timestamp injection on share pages ([39dc8bd](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/39dc8bdf6551ece62fc0ca3a843ca8d1478c2d5a))
* skip user custom instructions to avoid showing unsupported content ([b0b9916](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/b0b99165bdb4373237a6e8d2716271db81c4ad5a)), closes [#269](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/269)
* some chats cannot be exported because of missing message parts ([2e7ece8](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/2e7ece886ef0c4cc7d6a3d5016ebce8799acb6b1))
* stop idle queues silently on cancel and translate the Cancel button ([6136a9b](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/6136a9b0a1a997ab6fa30ce2692aa017797a4c23))
* storage should not throw error when not found ([3de59f8](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/3de59f8aae1e84c96879ebe9660a99be18ce1dbd)), closes [#101](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/101)
* stream conversation pages progressively to unblock Export All UI ([e927de3](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/e927de365872384ccae915c34861fa9bc592afaf))
* support extract id from gizmo path ([0bf3115](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/0bf3115948d85e2a639f269d6ca01b71c4fb853e))
* support message content type `execution_output` from plugin ([78e4ecf](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/78e4ecfd5d8ec16e52abf10208f868c74d44e234))
* support model name mapping for gpt-4o ([346e08f](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/346e08fbfe09cf87ccf5f0d56719c59954621294))
* support navlist and handle content reference in text and html ([54d4b6b](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/54d4b6b15b8a99d1cad598d2de20189aeade46df))
* support new ChatGPT sidebar layout ([e7f25fc](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/e7f25fc4b0a87d667cf0c5562dc992299cc95f56))
* support pandoar-next ([2d8a6ce](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/2d8a6ce5c1d3988af709b2ca59efb08305cbb3a3)), closes [#194](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/194)
* support url with model ([a50d580](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/a50d5802be2656450e25d66df8ad10d696ba5d43))
* thread might not exist ([d18bf3f](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/d18bf3f0620566e86369b6e16e2adeed544f2266))
* throw instead of exporting __share__null when share id is missing ([f0c0ffb](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/f0c0ffb78c1dd13e359fcd2a78809ea1c050906e))
* toggle should not shrink on small screen ([b152f44](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/b152f4493927fbaebe47327dc347e76c18ca1d61))
* try fix team workspace authentication issue ([1b9d3c1](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/1b9d3c13566a8c768990028229ef5082cb1b3a2d))
* update API interface (follow what OpenAI updated) ([922cb36](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/922cb36018473665f96a073e3e577bb61dc48e1a))
* update API interface and detect chat history disabled ([0fcb3d7](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/0fcb3d7efe0501736629d9c45695dff6df30e1ae))
* update chat url to /c/* ([96ec23e](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/96ec23e7bd63c8b8e92d5c4e6e7527bb6420f2c3))
* update closeDelay 300ms ([388a3ea](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/388a3ea718c6d916b818eb197b641a3930d473ba))
* update HTML export colors to match ChatGPT UI ([646b3f5](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/646b3f5a919330a43b9fba32d847347b80a34d6f))
* update image export colors to match ChatGPT UI ([dbb7022](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/dbb70228e4caf74bc32915207b071a205686c878))
* update script match for better coverage ([4300f4e](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/4300f4e81c9bbd3904422beb6cf1e13f4226ddf6)), closes [#335](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/335)
* update style to follow chatgpt updates ([8ee62f5](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/8ee62f52cf2279fb1d06630a77f034bdf4271dd8))
* update zhile.io API to fakegpt ([2723554](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/27235544637e4fb8835b6958b8dc7d7bee70a2da))
* use capped exponential backoff on 429s instead of aborting mid-batch ([#367](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/367)) ([544b85d](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/544b85d58a51038164d6c2e6cb12714d6a343440))
* use one avatar style for assistant messages in HTML export ([439c727](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/439c727897a4bde5f669c0036f610d2bacbe2425))
* use title from API in markdown and html export ([1f6f4d7](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/1f6f4d7219aa9ec599e3ebc94a6af250112e5293))
* user need to select project first to load the conversation list ([9ce72c0](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/9ce72c0f058be361a4edc3af0fc2227e03bc8f90))
* user's input should respect line break and be escaped ([46b5369](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/46b53692548880abb410af07c31585730fa74666)), closes [#95](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/95)
* write display math as `$$` blocks in markdown export ([64132e6](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/64132e63a7a05aa3d5888e5336df04afd12eb1e2)), closes [#281](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/281)
* z-index collision with history list ([c1faca9](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/c1faca9dee9efea4d8d23e38add1cc85236ea4a3)), closes [#164](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/164)
* zIndex should not overlap on setting menu ([39d13da](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/39d13da3465bdf4cc0b14344fcd345f063ecbb4a)), closes [#166](https://github.com/ottnorml/pionxzh_chatgpt-exporter/issues/166)


### Miscellaneous Chores

* script title and description support chinese ([2147a91](https://github.com/ottnorml/pionxzh_chatgpt-exporter/commit/2147a91740e8dd8b7ebae655cfbbf05ed9b7b93b))
